...
func NewCrossbowSkeleton(index int) *Enemy {
	e := &Enemy{}
	skills := make([]NPCSkill, 0)
	skills = append(skills,
		NPCSkills.NewCrossbowWind1(e),
		NPCSkills.NewCrossbowWind2(e),
		NPCSkills.NewCrossbowWind3(e),
		NPCSkills.NewCrossbowShoot(e))
